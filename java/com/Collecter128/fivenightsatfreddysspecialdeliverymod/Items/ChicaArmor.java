...
import com.Collecter128.fivenightsatfreddysspecialdeliverymod.entitytypes.model.chicaarmor_main;
...
public class ChicaArmor extends ArmorItem{

	public ChicaArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		chicaarmor_main model = new chicaarmor_main(1.0f, slot);
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "fnafarmod:textures/armor/chicaarmor_layer_1.png";
    }
}
