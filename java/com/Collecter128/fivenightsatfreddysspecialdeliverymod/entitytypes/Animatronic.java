...
public class Animatronic extends MonsterEntity{
...
//
//	public Animatronic(EntityType<? extends Animatronic> type, World worldIn) {
//		super(type, worldIn);
//		
//	}
//	public Animatronic(World worldIn) {
//		 this(EntityTypesInit.ANIMATRONIC, worldIn);
//	}
	...
	public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
	      return MonsterEntity.func_234295_eP_()
	    		  ...
	    		  //.createMutableAttribute(Attributes.ZOMBIE_SPAWN_REINFORCEMENTS); //DeeDee or Xor
	   }
...
//On right click with item/ switch AI
	   //On Shift right Click???
	   //Armor different when worn by mob???
	   //Stats determined by ??? Mods or partsor suit or AI or something?
	   //Hostile and Helpful versions
	   //Worn armor looks borkeny?
	   //Maybe different animatronic types Normal Mangle and smallish? Mabe something else???
...
//
//	   protected void registerGoals() {
//	      this.goalSelector.addGoal(4, new Animatronic.AttackTurtleEggGoal(this, 1.0D, 3));
//	      this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, 8.0F));
//	      this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
//	      this.applyEntityAI();
//	   }
...
//	         worldIn.playSound((PlayerEntity)null, pos, SoundEvents.ENTITY_ZOMBIE_DESTROY_EGG, SoundCategory.HOSTILE, 0.5F, 0.9F + Animatronic.this.rand.nextFloat() * 0.2F);
//	      }
//
