...
public class BlockFazboxFnaf3 extends Block{
	public static final DirectionProperty FACING = HorizontalBlock.FACING;

	public BlockFazboxFnaf3(Properties p_i48440_1_) {
		super(p_i48440_1_);
	...
	/**
	   ...
	   //public void onRemove(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
	      if (!worldIn.isClientSide) {
	    	  ItemStack itemstack1 = new ItemStack(ItemInit.fnaf3Springtrap_Head.get());
	    	 ItemStack itemstack2 = new ItemStack(ItemInit.fnaf3Springtrap_Body.get());
	    	 ItemStack itemstack3 = new ItemStack(ItemInit.fnaf3Springtrap_Legs.get());
	    	 ItemStack itemstack4 = new ItemStack(ItemInit.fnaf3Springtrap_Boots.get());
