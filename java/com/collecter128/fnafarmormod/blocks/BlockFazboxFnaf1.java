...
public class BlockFazboxFnaf1 extends Block{
	public static final DirectionProperty FACING = HorizontalBlock.FACING;

	public BlockFazboxFnaf1(Properties p_i48440_1_) {
		super(p_i48440_1_);
	      ...
	      if (!worldIn.isClientSide) {
	    	 ...
	    	 switch(RandomInt) {
	    	 	case 0: 
	    	 		...
	    	 		break;
	    	 	case 1: 
	    	 		if(RareArmorChance < 2) {
	    	 			itemstack1 = new ItemStack(ItemInit.fnaf1Bonnie_HeadEyeless.get());
	    	 		}
	    	 		else 
	    	 	...
	    	 	case 3: 
	    	 		...
	    	 		break;
	    	 	case 4: 
	    	 		itemstack1 = new ItemStack(ItemInit.fnaf1GoldenFreddy_Head.get());
	   	    	 ...
	   	    	 itemstack5 = new ItemStack(ItemInit.Fnaf1GoldenFreddyMicrophone.get());
	    	 		break;
