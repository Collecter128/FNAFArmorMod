...
import com.collecter128.fnafarmormod.blocks.BlockFazbox;
import com.collecter128.fnafarmormod.blocks.BlockFazboxFnaf1;
import com.collecter128.fnafarmormod.blocks.BlockFazboxFnaf2;
import com.collecter128.fnafarmormod.blocks.BlockFazboxMovie1;
import com.collecter128.fnafarmormod.blocks.BlockFazcoinPress;
import com.collecter128.fnafarmormod.blocks.FnafBannerLuckyBlock;
...
public class BlockInit {
	...
	public static final DeferredRegister<Block> Blocks = DeferredRegister.create(ForgeRegistries.BLOCKS, "fnafarmormod"); //MegamanArmorMod.Mod_ID
...
//	
	public static final RegistryObject<Block> FazCoinPress = Blocks.register("fazcoinpress",
			() -> new BlockFazcoinPress((AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE)
					.harvestTool(ToolType.PICKAXE)
					.strength(3.0F, 3.0F)) 
					.sound(SoundType.STONE)));
	
	public static final RegistryObject<Block> FazBox = Blocks.register("fazbox",
			() -> new BlockFazbox((AbstractBlock.Properties.of(Material.WOOL, MaterialColor.SNOW)
					.strength(1.0F)) 
					.sound(SoundType.WOOL)));

	public static final RegistryObject<Block> FazBoxFnaf1 = Blocks.register("fazboxfnaf1",
			() -> new BlockFazboxFnaf1((AbstractBlock.Properties.of(Material.WOOL, MaterialColor.SNOW)
					.strength(1.0F)) 
					.sound(SoundType.WOOL)));
	
	public static final RegistryObject<Block> FazBoxFnaf2 = Blocks.register("fazboxfnaf2",
			() -> new BlockFazboxFnaf2((AbstractBlock.Properties.of(Material.WOOL, MaterialColor.SNOW)
					.strength(1.0F)) 
					.sound(SoundType.WOOL)));
	
	public static final RegistryObject<Block> FazBoxMovie1 = Blocks.register("fazboxmovie1",
			() -> new BlockFazboxMovie1((AbstractBlock.Properties.of(Material.WOOL, MaterialColor.SNOW)
					.strength(1.0F)) 
					.sound(SoundType.WOOL)));
	
	public static final RegistryObject<Block> FazBoxBanner = Blocks.register("fazboxbanner",
			() -> new FnafBannerLuckyBlock((AbstractBlock.Properties.of(Material.WOOL, MaterialColor.SNOW)
					.strength(1.0F)) 
					.sound(SoundType.WOOL)));
